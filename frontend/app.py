...
async def callback(
    ...
    if Authorization is None:
        ...
        return templates.TemplateResponse(
            ...
            {
                "request": request,
                "page": "CT600 Taping Vision Guide System",
                "title": title,
            },
        )

    logger.info(
        f"Authorization token received (first 50 chars): {Authorization[:50]}..."
    )
